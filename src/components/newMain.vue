    ...
    <div v-else>
      ...
      <div class="page__wrapper">
        <div class="page__content">
            ...
            <nav class="header__nav">
              <ul class="header__nav-list">
                <li class="header__nav-item">
                  <button id="fisrtMoreBtn" class="header__nav-btn">Помощь</button>
                </li>
                <li class="header__nav-item">
                  <a class="header__nav-a" @click="logout">Выйти</a>
                </li>
                <!-- PROFILE -->
                <li class="header__nav-item header__profile " @click="profileToggle">
                  <!-- NAME -->
                  <!-- При клике -> меню редактированя профиля -->
                  <div class="header__profile-name">{{firstName}}</div>
                  <div class="header__profile-photo">
                    <img class="header__profile-img" src="images/main/profile.jpg" alt="Profile" />
                  </div>
                </li>
                <!-- END OF PROFILE -->
              </ul>
          ...
          <div class="start" v-if="startDisabled">
            ...
            <div class="start__message">
              <span>
                ...
                <br />Прежде чем начать работу, необходимо наcтроить
                <br />ваш
                профиль Allquasars. Нажмите на кнопку
                <br />"Настроить профиль"
                для перехода в панель редактирования.
              </span>
            </div>
            <div class="start__button" >
              <button class="start__button-item" @click="profileToggle">Настроить профиль</button>
            </div>
          </div>
     <!-- </transition > -->
              ...
              <div class="profile__nav">
                <div class="profile__nav-content">
                  <div class="profile__section-name">
                    <span class="profile__section-content">Редактирование аккаунта</span>
                  </div>
                  <div class="profile__nav-account" @click="profileToggle">
                    ...
                    <div class="profile__nav-account-setting">
                      ...
                      <button class="profile__nav-account-btn profile__nav-account-delete">Удалить</button>
                    </div>
                  </div>
                  <ul class="profile__nav-list">
                    <li class="profile__nav-item-first profile__nav-item">
                      <a href="#" class="profile__nav-btn profile__nav-btn-profile">
                  ...
                  <ul class="profile__nav-list profile__nav-list-support">
                    ...
                    <li class="profile__nav-item">
                      <a class="profile__nav-a" href="#">Политика конфиденциальности</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="profile__settings">
                ...
                <div class="profile__avatar">
                  ...
                  <div class="profile__avatar-message">
                    <span
                      class="profile__avatar-message-item"
                    >Размер изображения не должен превышать 1МБ.</span>
                    <span class="profile__avatar-message-item">Доступные форматы JPG, JPEG или PNG.</span>
                  </div>
                </div>
                <div class="profile__section-name">
                  <span class="profile__section-content">Персональные данные</span>
                </div>

                <!-- во все инпуты передай value то которое ввел пользователь при регистрации чтобы заново не вводить! -->
                <!-- имя и фамилия -->
                <div class="portfolio__form portfolio__form--grided portfolio__initials">
                  <span
                    id="nameWrapper"
                  ...
                  >
                    <input
                      @focus="inputFirstName = true"
                      @blur="inputFirstName = false"
                      v-model="firstName"
                      id="inputName"
                  ...
                  >
                    <input
                      @focus="inputLastName = true"
                      @blur="inputLastName = false"
                      v-model="lastName"
                      id="inputSurname"
                      class="portfolio__form-input"
                      type="text"
                ...
                <div class="portfolio__form portfolio__form--grided portfolio__age">
                  <span
                    id="dateWrapper"
                    class="portfolio__form-wrap portfolio__initials-wrap form__clue"
                  ...
                  >
                    <input
                      @focus="inputBirthdayDate = true"
                      @blur="inputBirthdayDate = false"
                ...
                <!-- фильтры -->
                <div class="profile__section-name">
                  <span class="profile__section-content">Подробная информация</span>
                ...
                <div class="portfolio__filter">
                  <!-- тип -->
                  <div
                    class="portfolio__filter-type portfolio__filter-section"
                    v-if="type!='manager'"
                  >
                    <div class="portfolio__filter-option portfolio__filter-option-type">
                      ...
                      <div class="portfolio__filter--selected portfolio__filter-item">
                  ...
                  <!-- страна -->
                  <div class="portfolio__filter-country portfolio__filter-section">
                  ...
                  >
                    <div class="portfolio__filter-option">
                      ...
                      <div
                        ...
                        @click="height=1"
                      >
                        <span class="portfolio__filter-text">Менее 150 см</span>
                      </div>
                      <div
                        class="portfolio__filter-item"
                ...
                <div class="portfolio__form portfolio__bio">
                  <span id="bioWrapper" class="portfolio__form-wrap portfolio__bio-wrap">
                    <textarea
                      v-model="description"
                      id="inputBio"
                  ...
                  <div id="galleryWrapper" class="portfolio__gallery-content">
                    <div id="galleryInputWrapper" class="portfolio__gallery-item">
                      <div class="portfolio__gallery-input-wrapp">
                        <label for="inputGallery" class="portfolio__gallery-input">
                ...
                <div class="portfolio__comment portfolio__comment-gallery">
                  <span id="galleryCounter" class="portfolio__comment-text">0</span>
                  <span
                    class="portfolio__comment-text"
                ...
                <div class="portfolio__form portfolio__form--grided portfolio__link">
                  <span
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.soundcloud = true"
                      @blur="inputLinks.soundcloud = false"
                      id="inputSoundcloud"
                      class="portfolio__form-input"
                      type="text"
                    />
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.spotify = true"
                      @blur="inputLinks.spotify = false"
                      id="inputSpotify"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.itunes = true"
                      @blur="inputLinks.itunes = false"
                      id="inputiTunes"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.applemusic = true"
                      @blur="inputLinks.applemusic = false"
                      id="inputAppleMusic"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.youtube = true"
                      @blur="inputLinks.youtube = false"
                      id="inputYoutube"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      v-model="links.vimeo"
                      @focus="inputLinks.vimeo = true"
                      @blur="inputLinks.vimeo = false"
                      id="inputVimeo"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.beatport = true"
                      @blur="inputLinks.beatport = false"
                      id="inputBeatport"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                  ...
                  >
                    <input
                      ...
                      @focus="inputLinks.mixcolud = true"
                      @blur="inputLinks.mixcolud = false"
                      id="inputMixcloud"
                      class="portfolio__form-input"
                      type="text"
                      autocomplete="off"
                ...
                <div class="portfolio__form portfolio__form--grided portfolio__email">
                  <span
                  ...
                  >
                    <input
                      @focus="inputNickName = true"
                      @blur="inputNickName = false"
                      v-model="nickname"
                      disabled
                      id="inputNickname"
                      class="portfolio__form-input"
                ...
                <div class="portfolio__form portfolio__form--grided">
                  ...
                  >
                    <input
                      @focus="inputPasswordcheck = true"
                      @blur="inputPasswordcheck = false"
              ...
              <div class="main__search">
                <div class="search__wrapper">
                  ...
                  <div id="filterWrapper" class="search__filter " :class="{'search__filter--closed':!showfiltersFrom}">
                    ...
                    <!-- возраст -->
                    <div
                      class="search__filter-age search__filter-section search__filter-section--last"
                    >
                      <div class="search__filter-option">
                        <div class="search__filter-headering">
...
export default {
  ...
  computed: {
    inputFirstNameComp: function () {
      if (this.inputFirstName || !this.firstName == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLastNameComp: function () {
      if (this.inputLastName || !this.lastName == "") {
        return true;
      } else {
        return false;
      }
    },
    inputBirthdayDateComp: function () {
      if (this.inputBirthdayDate || !this.birthdayDate == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkSoundcloudComp: function () {
      if (this.inputLinks.soundcloud || !this.links.soundcloud == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkSpotifyComp: function () {
      if (this.inputLinks.spotify || !this.links.spotify == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkItunesComp: function () {
      if (this.inputLinks.itunes || !this.links.itunes == "") {
        return true;
      } else {
        return false;
      }
    },
    inputApplemusicComp: function () {
      if (this.inputLinks.applemusic || !this.links.applemusic == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkYoutubeComp: function () {
      if (this.inputLinks.youtube || !this.links.youtube == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkVimeoComp: function () {
      if (this.inputLinks.vimeo || !this.links.vimeo == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkBeatportComp: function () {
      if (this.inputLinks.beatport || !this.links.beatport == "") {
        return true;
      } else {
        return false;
      }
    },
    inputLinkMixcoludComp: function () {
      if (this.inputLinks.mixcolud || !this.links.mixcolud == "") {
        return true;
      } else {
        return false;
      }
    },
    inputEmailComp: function () {
    ...
    inputNicknameComp: function () {
      if (this.inputNickName || !this.nickname == "") {
        return true;
      } else {
        return false;
      }
    },
    inputPasswordComp: function () {
    ...
    inputPasswordCheckComp: function () {
      if (this.inputPasswordcheck || !this.passwordcheck == "") {
        return true;
      } else {
        return false;
      }
    ...
    axios
      ...
      .then(
        (res) => {
          ...
          this.description = res.data.user.description || this.description;

          this.links = res.data.user.links || this.links;
          this.countrys = res.data.user.countrys || this.countrys;
        ...
        .then(
          (res) => {
            if (res.status == 200) {
              this.popupShow(
                "Успех!",
                "Ваши данные успешно схранены, обновите страницу."
              );
